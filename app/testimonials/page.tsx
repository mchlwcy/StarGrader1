    ...
    <div className="min-h-dvh flex flex-col bg-black text-white">
      ...
      <main className="flex-1 px-4 md:px-8">
        <div className="mx-auto max-w-6xl pt-20 md:pt-28 pb-10 md:pb-16">
          <Reveal>
            <h1 className="text-4xl md:text-6xl font-semibold tracking-tight">{"User testimonials"}</h1>
          </Reveal>
          <p className="mt-4 text-neutral-300 max-w-2xl">
            {"Real stories from students and teachers using StarGrader to aim for 5**."}
          </p>
